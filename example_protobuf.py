...
try:
    ...
    if horizons:
        ...
        # Step 2: Fetch binary data separately
    ...
    print(f"⚠ Skipping Example 1: {e}")
    print("  Install with: pip install dsis-schemas[protobuf]")
except Exception as e:
    print(f"⚠ Example 1 failed: {str(e)[:200]}")
...
try:
    ...
    print(f"⚠ Skipping Example 2: {e}")
    print("  Install with: pip install dsis-schemas[protobuf]")
except Exception as e:
    print(f"⚠ Example 2 failed: {str(e)[:200]}")
...
try:
    ...
    if seismic_datasets:
        ...
        # Step 2: Fetch binary data (WARNING: Can be very large!)
    ...
    print(f"⚠ Example 3 failed: {str(e)[:200]}")
